...
#include "ObjectsEU.h"
	...
	*/
	...
	{
		LocalPlayer = 0x348B45C, // 74 52 3B 35 ? ? ? ? 
		ObjectManager = 0x1BE967C, //
		ObjectList = ObjectManager + 0x14,
		MaxSize = ObjectManager + 0x4,
	...
	enum class GameObjectFunctions
	{
		...
		OnDoCast = 0x4993D0,// Possible mismatch
		CaptureTurret = 0x00895c10,// Possible mismatch
		PrintChat = 0x55F7E0,
		ChatClient = 0x1BE712C,
	};
	...
	*/
	enum class pwHud
	{
		pwHud_Instance = 0x1B96CB4,
		pwHud_OnDraw = 0x00cca2e0,
		SetUISelectedObjId = 0,
	...
	*/
	...
	{
		FPS = 0x3205C4C,
		r3dRendererInstance = 0x34AB384, // Possible mismatch
		DrawCircularRangeIndicator = 0x4F1720,// Possible mismatch //‬ 0x4F18D0
		r3dScreenTo3D = 0x009b0830,// Possible mismatch
		r3dProjectToScreen = 0x008ff560,
		W2S = 0x921C80, // 921DE0 -> E8 ? ? ? ? 83 C4 08 8D 4E 1C 
	};
